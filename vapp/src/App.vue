<template>
  <div v-if="isDrizzleInitialized" id="app" class="flex-row md:flex-row">
    <div id="app">
      <!-- header -->
      ...
      <!-- hero -->
      <!-- https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=2100 -->
      <div
        id="hero"
        class="w-screen py-24 px-6 bg-cover bg-no-repeat bg-center relative z-10"
        style="background-image: url('https://images.unsplash.com/photo-1523217582562-09d0def993a6?w=2100');"
      >
        <div class="container max-w-4xl mx-auto text-center">
          <h1
            class="text-xl leading-tight md:text-3xl text-center text-gray-900 mb-3"
          >
            Make Real Estate investment available
          </h1>
          <p class="text-md md:text-lg text-center text-gray-900 ">
            Take part in the first platform that anable anyone to become a real
            estate investor at a low cost without compromising high return
          </p>
      ...
      <div class="w-full px-6 py-12 bg-white">
        ...
        >
          <div
            class="container w-full mx-auto text-center flex flex-wrap items-stretch justify-evenly md:flex-no-wrap"
          >
            <CreationCard />
  ...
  <div v-else class="text-center">Waiting for Metamask connection</div>
</template>
